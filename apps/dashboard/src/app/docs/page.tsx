            ...
            <section id="introduction" className="space-y-6">
                ...
                <div className="prose prose-invert max-w-none text-zinc-300">
                    <p className="leading-relaxed">
                        IzzU is a self-hosted, open-source biometric authentication platform designed to replace expensive cloud providers like Auth0 or AWS Rekognition.
                        It runs entirely on your infrastructure, ensuring <strong className="text-white">zero data leakage</strong> and <strong className="text-white">zero vendor lock-in</strong>.
                    </p>
            ...
            <section id="architecture" className="space-y-6 pt-10 border-t border-zinc-900">
                ...
                <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-6 space-y-4">
                    <p className="text-zinc-400">
                        IzzU uses a multi-layered approach to security, combining high-performance Python engines with a scalable Next.js frontend.
                    </p>
                    <ul className="space-y-2 text-sm text-zinc-300">
                        <li className="flex gap-2"><span className="text-blue-500 font-mono">Face Engine:</span> Python 3.11 + dlib (ResNet) + OpenCV</li>
                        <li className="flex gap-2"><span className="text-green-500 font-mono">Liveness:</span> MediaPipe 468-point Mesh + Laplacian Variance</li>
                        <li className="flex gap-2"><span className="text-purple-500 font-mono">Storage:</span> PostgreSQL (User Data) + Redis (Sessions)</li>
                        <li className="flex gap-2"><span className="text-orange-500 font-mono">Encryption:</span> AES-256-GCM (Simulated Secure Enclave)</li>
                    </ul>
                </div>
            </section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-gradient-to-br from-zinc-900 to-black border border-zinc-800 rounded-xl p-6">
                        ...
                        <p className="text-zinc-400 text-sm leading-relaxed">
                            We use <strong>Laplacian Variance</strong> to detect "flat" images (screens, printed photos).
                            Additionally, <strong>Eye Aspect Ratio (EAR)</strong> tracking ensures the user is blinking and alive,
                            while <strong>Head Pose Estimation</strong> confirms they are looking directly at the camera.
                        </p>
                    </div>
                    <div className="bg-gradient-to-br from-zinc-900 to-black border border-zinc-800 rounded-xl p-6">
                        <h3 className="font-semibold text-lg mb-2">Secure Enclave</h3>
                        <p className="text-zinc-400 text-sm leading-relaxed">
                            Raw face images are <strong>never stored</strong> for recognition. We generate a 128-dimensional mathematical vector,
                            encrypt it using <strong>AES-256-GCM</strong> with a master key, and store only the cipher blob.
                        </p>
                    </div>
                </div>
            </section>
...
docker compose up -d --build`} />
            ...
            <section id="sdk" className="space-y-6 pt-10 border-t border-zinc-900">
                ...
                <CodeBlock code={`import { IzzUProvider } from "@izzu/react";
