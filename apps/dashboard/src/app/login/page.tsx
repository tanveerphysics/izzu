...
export default function LoginPage() {
    ...
    const DEFAULT_PROJECT_ID = "b184a8cd-f212-4499-bb96-df4da2c68a51";
        ...
        try {
            ...
            if (!optionsRes.ok) {
                if (optionsData.error === "No passkeys registered") {
                    throw new Error("No passkey registered for this email. Sign in with email first, then add a passkey in settings.");
                }
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-zinc-400 text-sm">
                        {showOtpInput
                            ...
                            : (isSignUp ? "Get started with your developer account." : "Enter your email to sign in.")}
                    </p>
                </div>
                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                        {isSignUp && (
                            <>
                                ...
                                <div>
                                    <label className="block text-xs font-medium text-zinc-400 mb-1.5 uppercase tracking-wider">Mobile Number</label>
                                    <input
                                        type="tel"
                                        required
                                        value={mobile}
                        ...
                        >
                            {isLoading ? <Loader2 className="w-4 h-4 animate-spin" /> : (isSignUp ? "Sign Up with Email" : "Continue with Email")}
                        </button>
