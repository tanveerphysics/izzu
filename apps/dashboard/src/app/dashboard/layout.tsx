            ...
            <aside className="hidden md:flex flex-col w-64 border-r border-zinc-800/50 bg-zinc-900/20 backdrop-blur-xl">
                ...
                <div className="h-16 flex items-center px-6 border-b border-zinc-800/50">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-[10px] bg-zinc-800 text-zinc-400 px-1.5 py-0.5 rounded border border-zinc-700 ml-2">BETA</span>
                    </div>
                </div>
                    ...
                    {navItems.map((item) => {
                        ...
                        return (
                            <Link
                                key={item.href}
                                href={item.href}
                                className={`flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-lg transition-all duration-200 group relative ${isActive
                ...
                <div className="p-4 border-t border-zinc-800/50">
                    <button className="flex items-center gap-3 w-full p-2 rounded-lg hover:bg-zinc-800/30 transition-colors text-left group">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs text-zinc-500 truncate group-hover:text-zinc-400">tanishq@izzu.com</p>
                        </div>
            ...
            <main className="flex-1 flex flex-col min-w-0 bg-black relative">
                ...
                <header className="h-16 border-b border-zinc-800/50 flex items-center justify-between px-8 bg-black/50 backdrop-blur-md sticky top-0 z-20">
                    <div className="flex items-center gap-4 text-sm text-zinc-400">
                        ...
                        <span className="text-white font-medium">{navItems.find(i => i.href === pathname)?.label || "Dashboard"}</span>
                    </div>
