...
export function IzzUAuth({
    ...
    // Auth state
    const [step, setStep] = useState<AuthStep>(mode === "signin" && allowFaceOnlyLogin ? "face-scan" : "email");
            ...
            <div style={containerStyle}>
                <div style={{ textAlign: "center", padding: "40px 0" }}>
                    ...
                    <p style={{ color: "#71717a", marginTop: "8px" }}>
                        {mode === "signup" ? "Your Face ID has been registered." : "Face ID verified successfully."}
                    </p>
                </div>
            </div>
        );
    ...
    if (step === "face-scan") {
        return (
            <div style={containerStyle}>
                ...
                <p style={{ textAlign: "center", color: "#71717a", marginBottom: "20px" }}>
                ...
                {cameraError ? (
                    ...
                    <>
                        <div style={{ borderRadius: "12px", overflow: "hidden", marginBottom: "16px", position: "relative" }}>
                            ...
                            {!cameraActive && (
                                <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center", backgroundColor: "#18181b" }}>
                        ...
                        <button
                            ...
                            style={{ ...buttonStyle, backgroundColor: "#10b981", opacity: isLoading ? 0.7 : 1 }}
                        >
                ...
                <div style={{ textAlign: "center", marginTop: "20px" }}>
                    <button
                        onClick={() => { stopCamera(); setStep("email"); }}
                ...
                {locationError && (
                    <p style={{ color: "#f59e0b", fontSize: "12px", textAlign: "center", marginTop: "12px" }}>
                        ⚠️ {locationError}
                    </p>
                )}
            </div>
            ...
            <div style={containerStyle}>
                ...
                <form onSubmit={handleOtpSubmit}>
                    <input
                        ...
                        placeholder="000000"
                        maxLength={6}
                        style={{ ...inputStyle, textAlign: "center", fontSize: "28px", letterSpacing: "12px" }}
                    />
        ...
        return (
            <div style={containerStyle}>
                ...
                <button
                    ...
                    style={{ width: "100%", marginTop: "12px", background: "none", border: "none", color: "#71717a", cursor: "pointer" }}
                >
                    ← Back
                </button>
            </div>
    ...
    return (
        <div style={containerStyle}>
            ...
            <p style={{ textAlign: "center", color: "#52525b", fontSize: "12px", marginTop: "20px" }}>
