...
const run = async () => {
    ...
    // 1. Check Env
    const connectionString = process.env.DATABASE_URL || "postgres://postgres:postgres@localhost:5432/izzu";
    ...
    try {
        ...
        console.error("   Should be listening on port 5432 with user 'postgres' and password 'postgres'.");
