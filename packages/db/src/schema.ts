import { pgTable, text, timestamp, uuid, index, uniqueIndex, boolean, jsonb } from "drizzle-orm/pg-core";
...
export const identities = pgTable("identities", {
    id: uuid("id").defaultRandom().primaryKey(),
    endUserId: uuid("end_user_id").references(() => endUsers.id, { onDelete: "cascade" }).notNull(),
    provider: text("provider", { enum: ["email", "phone", "google", "apple", "microsoft", "github"] }).notNull(),
